...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'matematik')
        <tr>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'edebiyat')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'fizik')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'kimya')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'biyoloji')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'tarih')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'cografya')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'din')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'ingilizce')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
...
@foreach( $lessons as $lesson)
    ...
    @if($lesson->lesson_id == 'ekpss' && $lesson->lesson_group == 'almanca')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/ders/{{ $lesson->title_id }}">{{ $lesson->title }}</a>
