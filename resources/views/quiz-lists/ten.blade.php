...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'matematik')
        <tr>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'edebiyat')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'fizik')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'kimya')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'biyoloji')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'tarih')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'cografya')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'din')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'ingilizce')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
...
@foreach( $quizes as $quiz)
    ...
    @if($quizes->quiz_id == 10 && $quizes->quiz_group == 'almanca')
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                    <a class="text-xl" href="{{ config('app.url') }}/dersler/{{ $quizes->title_id }}">{{ $quizes->title }}</a>
